...
.rd-navbar-static .rd-nav-item.active .rd-nav-link {
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel"> 
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a href="index.php"><img class="brand-logo-light" src="images/banner/LOGO.png" alt="" width="140" height="57" srcset="images/banner/LOGO.png 2x"/></a></div>
                </div>
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    <!-- RD Navbar Nav-->
                    <ul class="rd-navbar-nav">
                      <li  class="rd-nav-item active"><a style= "color:white;" class="rd-nav-link" href="index.html">Home</a>
                      </li>
                    
                      <li  class="rd-nav-item active"><a style= "color:white;" class="rd-nav-link" href="ngodisplay.php">NGO</a>
                      </li>
                ...
                <button class="button button-white button-sm" type="submit"  onclick="location.href='Cinema-Reservation/booktable.php'"   >book Table</button>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body"><button type="button" class="btn btn-primary"  onclick="location.href='fooddisplay.php'">For Food</button>
